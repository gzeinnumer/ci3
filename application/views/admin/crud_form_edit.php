      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?= form_open(base_url('crud_c_design/edit/' . $data->id), ' class="form-horizontal"'); ?>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group bmd-form-group">
                  <label class="bmd-label-floating">Username</label>
                  <input type="text" name="username_i" class="form-control" value="<?php echo $data->username ?>">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group bmd-form-group">
                  ...
                  <input type="text" name="name_i" class="form-control" value="<?php echo $data->name ?>">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group bmd-form-group">
                  ...
                  <input type="text" name="pass_i" class="form-control" value="<?php echo $data->pass ?>">
                </div>
              </div>
            </div>
            <button type="submit" name="submit" class="btn btn-success pull-right">Edit Data<div class="ripple-container"></div></button>
